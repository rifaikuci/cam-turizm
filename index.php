...
require(dirname(__FILE__) . "/common/db/index.php");
require(dirname(__FILE__) . "/common/methods/index.php");
require(dirname(__FILE__) . "/common/data/index.php");
require(dirname(__FILE__) . "/front/include/lang-control.php");

if (file_exists(dirname(__FILE__) . "/front/lib/" . $lang . ".json")) {
    $content_json = file_get_contents(dirname(__FILE__) . "/front/lib/" . $lang . ".json");
    $content = json_decode($content_json, false);

} else {
    if (file_exists(dirname(__FILE__) . "/front/lib/tr.json")) {

        $content_json = file_get_contents(dirname(__FILE__) . "/front/lib/tr.json");
        $content = json_decode($content_json, false);
    }
}
?>
...
<head>
    <title><?php echo $content->home->title; ?></title>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-xl-11 d-flex align-items-center justify-content-between">
                ...
                <!-- <a href="index.html" class="logo"><img src="front/assets/img/logo.png" alt="" class="img-fluid"></a>-->
    ...
    <div class="hero-container">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image: url(front/assets/img/hero-carousel/1.jpg)">
                ...
                <div class="carousel-item" style="background-image: url(front/assets/img/hero-carousel/2.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                ...
                <div class="carousel-item" style="background-image: url(front/assets/img/hero-carousel/3.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                ...
                <div class="carousel-item" style="background-image: url(front/assets/img/hero-carousel/4.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                ...
                <div class="carousel-item" style="background-image: url(front/assets/img/hero-carousel/5.jpg)">
                    <div class="carousel-container">
                        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/app1.jpg" data-lightbox="portfolio" data-title="App 1"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/web3.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/app2.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/card2.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/web2.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/app3.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/card1.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/card3.jpg" class="link-preview portfolio-lightbox"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <div class="portfolio-wrap">
                    <figure>
                        ...
                        <a href="front/assets/img/portfolio/web1.jpg" class="link-preview portfolio-lightbox"
        ...
        <div class="container" data-aos="zoom-in">
            ...
            <div class="clients-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-1.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-2.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-3.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-4.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-5.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-6.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-7.png" class="img-fluid" alt="">
                    </div>
                    <div class="swiper-slide"><img src="front/assets/img/clients/client-8.png" class="img-fluid" alt="">
                    </div>
                </div>
