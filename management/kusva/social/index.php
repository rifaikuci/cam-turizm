...
if (isset($_POST['socialInsert'])) {

    $dirName = basename(__DIR__);
    $path = base_url_back() . "src/" . $dirName;
    $data = array();
    if (isset($_FILES['image']) && $_FILES['image']['name']) {
        $file = imageUpload("social", 'image', '');
...
if (isset($_GET['socialDelete'])) {
    $id = $_GET['socialDelete'];
    $row = getDataRow("$id", "tblSocial", $db);
    $sql = delete($id, 'tblSocial');
    $dirName = basename(__DIR__);
    $path = base_url_back() . "src/" . $dirName;
