<section class="content">
    ...
    <form method="post" action="<?php echo base_url_back() . 'kusva/index.php' ?>"
        ...
        <?php
        getTextHidden("packetsInsert", "packetsInsert");
        ?>
        <div class="card card-dark">

            <div class="card-header">
                <?php expandable_header(); ?>
                <h3 class="card-title">Paket Bilgileri (Türkçe)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <?php
        ...
        <div class="card card-dark">
            ...
            <div class="card-header">
                <?php expandable_header(); ?>
                <h3 class="card-title">Paket Bilgileri (İngilizce)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <?php
        ...
        <div class="card card-dark">
            ...
            <div class="card-header">
                <?php expandable_header(); ?>
                <h3 class="card-title">Paket Bilgileri (Almanca)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <?php
