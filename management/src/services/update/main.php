...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $row = getDataRow($id, 'tblServices', $db);
...
<section class="content">
    ...
    <form method="post" action="<?php echo base_url_back() . 'kusva/index.php' ?>"
        ...
        <?php
        getTextHidden("servicesUpdate", $id);
        ...
        <div class="card card-dark">
            ...
            <div class="card-header">
                ...
                <h3 class="card-title">Servis Bilgileri (Türkçe)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <?php
        ...
        <div class="card card-dark">
            ...
            <div class="card-header">
                <?php expandable_header(); ?>
                <h3 class="card-title">Servis Bilgileri (İngilizce)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <?php
        ...
        <div class="card card-dark">
            ...
            <div class="card-header">
                <?php expandable_header(); ?>
                <h3 class="card-title">Servis Bilgileri (Almanca)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <?php
