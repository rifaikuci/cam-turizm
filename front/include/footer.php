<?php $smedia = getAllData("tblSocial", "", $db); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <div class="social-links">
                        <?php for ($i = 0; $i < count($smedia); $i++) { ?>
                            <a target="_blank" href="<?php echo $smedia[$i]['link']; ?>" class="<?php echo $smedia[$i]['title']; ?>"><i
                                        class="<?php echo "bi bi-" . seo($smedia[$i]['title']) ?>"></i></a>
                        <?php } ?>
                    </div>
